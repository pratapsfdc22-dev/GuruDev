...
async function test(): Promise<void> {
  ...
  fs.writeFileSync('/tmp/query2-literal.sql', sqlCommand)
  
  console.log('SQL written to /tmp/query2-literal.sql')
  console.log('\n' + '═'.repeat(80))
  console.log('COPY THIS ENTIRE LINE TO SUPABASE SQL EDITOR:')
